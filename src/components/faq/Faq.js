    ...
    return (
        <section className={classes.faq}>
            ...
            <div className={classes.content}>
                ...
                <p>
                    The team at {companyName} Services can install, maintain, and repair four primary types of furnaces
                    for our clients. These include natural gas furnaces, oil furnaces, electric furnaces, and propane
                    furnaces.
                </p>
            </div>
            <div className={classes.content}>
